         ...
         <main className="landing-main">
            <section className="landing-hero">
               ...
               <p className="landing-hero-subtitle">
                  {productName} helps partners manage titles, chapters, and audience insights in one
                  place. Reach more listeners with a platform built for quality audio publishing.
               </p>
            ...
            <section className="landing-features">
               <article className="landing-feature-card">
                  ...
                  <p>
                     Organize audiobooks, chapters, and metadata so your library stays consistent and
                     easy to browse.
                  </p>
               </article>
               <article className="landing-feature-card">
                  ...
                  <p>
                     Understand how listeners engage with your content and make data-informed
               ...
               <article className="landing-feature-card">
                  ...
                  <p>
                     Onboard your organization, invite team members, and publish under your brand
                     with clear roles and access.
                  </p>
               </article>
            </section>
         </main>
