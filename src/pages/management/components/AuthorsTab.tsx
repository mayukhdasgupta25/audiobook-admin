...
import { getAuthorDisplayName } from '../../../utils/audiobookApi';
...
const AuthorsTab: React.FC = () => {
  ...
  const { authors, loading: authorsLoading } = useAppSelector(
    state => state.authors
  );
  ...
  const filteredAuthors = useMemo(() => {
    ...
    return authors.filter(author => {
      ...
      return (
        ...
        author.userId.toLowerCase().includes(query)
      );
    });
  }, [authors, searchQuery]);
  ...
  return (
    <div className="authors-tab">
                ...
                <div className="author-card-content">
                  ...
                  <div className="author-details">
                    <div className="author-detail-item">
                      <span className="author-detail-label">Slug:</span>
                      <span className="author-detail-value">
                        {author.slug}
                      </span>
                    </div>
                    {author.contact && (
      ...
      <ConfirmDialog
        ...
        title="Delete Author"
        message={`Are you sure you want to delete "${deletingAuthor ? getAuthorDisplayName(deletingAuthor) : ''}"? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
