...
function PartnerRegister() {
   ...
   const handleIndividualDetailsSubmit = (data: RegisterIndividualDetailsData) => {
   ...
   const handleIndividualPasswordSubmit = async (data: RegisterIndividualPasswordData) => {
   ...
   const handleVerifyOtp = async (data: VerifyOtpFormData) => {
      ...
      try {
         ...
         await verifyRegistrationOtp({
            ...
            firstName: partnerType === 'organization' ? data.firstName || undefined : undefined,

            lastName: partnerType === 'organization' ? data.lastName || undefined : undefined,
