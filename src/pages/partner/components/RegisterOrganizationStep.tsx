...
function RegisterOrganizationStep({ isLoading, onSubmit, onBack }: RegisterOrganizationStepProps) {
   ...
   return (
      <form onSubmit={handleSubmit} className="partner-register-form">
         ...
         <div className="partner-form-group">
            ...
            <input id="orgRole" type="text" value="ADMIN" readOnly disabled={isLoading} />
         </div>
