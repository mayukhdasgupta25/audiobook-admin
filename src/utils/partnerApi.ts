...
function storeTokenFromResponse(response: RegisterResponse | VerifyRegistrationOtpResponse): void {
...
export async function verifyRegistrationOtp(
   ...
   try {
      ...
      const response = await fetch(`${getAuthApiBaseUrl()}/auth/verify-registration-otp`, {
         method: 'POST',
         credentials: 'include',
         headers: getPublicJsonHeaders(),
